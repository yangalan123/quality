...
class QualityConfig(datasets.BuilderConfig):
    def __init__(self, features, data_url, label_classes=("0", "1", "2", "3"), **kwargs):
        super(QualityConfig, self).__init__(version=datasets.Version("0.1"), **kwargs)
