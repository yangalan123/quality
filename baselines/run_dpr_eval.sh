...
eval_phase="validation"
for max_len in 25 50 100
do
    for experiment in {0..19}
    ...
    #EXPDIR=./experiment/extractive_dpr_deberta_large_epoch_20
        ...
        #base_exp_dir=extractive_dpr_agent_first_20splits/agent
        #base_exp_dir=dpr_agent_pegasus_sum_300_concat/agent
        #base_exp_dir=dpr_agent_pegasus_sum_rest_300_concat/agent
        #base_exp_dir=dpr_agent_pegasus_sum_rest_300_concat/agent
        #base_exp_dir=dpr_agent_dpr_sum_combine_20splits_maxlen_300_reverse_concat/agent
        #base_exp_dir=dpr_agent_dpr_sum_combine_20splits_maxlen_150_reverse_concat/agent
        base_exp_dir=dpr_agent_dpr_sum_combine_20splits_maxlen_150_${max_len}_concat/agent
        ...
        CUDA_VISIBLE_DEVICES=1 python lrqa/run_lrqa.py \
